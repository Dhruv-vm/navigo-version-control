...
export default function FlightsPage() {
  ...
  return (
    <div className="relative min-h-screen text-white overflow-hidden">
      ...
      {/* GLOW */}
      <div className="absolute top-[-150px] left-[10%] w-[500px] h-[500px] bg-blue-500/20 blur-[140px] rounded-full" />
      <div className="absolute bottom-[-200px] right-[10%] w-[500px] h-[500px] bg-cyan-400/10 blur-[140px] rounded-full" />
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-24 pb-6">
          <div className="bg-gradient-to-r from-[#0B1220] via-[#0f1c2e] to-[#0B1220] border border-white/10 rounded-2xl px-10 py-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-10">
                ...
                <div className="flex items-center gap-8 pr-8 border-r border-white/10">
                  ...
                  <div className="w-14 h-14 flex items-center justify-center rounded-full bg-white/5 border border-white/10">⇄</div>
                  <div>
                    <p className="text-xs text-gray-500">To</p>
                    <p className="text-4xl font-bold text-yellow-400">{destination}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center pr-8 border-r border-white/10">
                  <div className="pr-6">
                    ...
                    <p className="text-lg font-semibold">{formattedDepart.date}</p>
                  </div>
                  {mode === "roundtrip" && returnDate && (
                    <>
                      ...
                      <div className="pl-6">
                        ...
                        <p className="text-lg font-semibold">{formatDate(returnDate).date}</p>
                      </div>
                    </>
                  )}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-12 gap-6 pb-32">
          ...
          <div className="col-span-3 space-y-6">
            <div className="bg-gradient-to-b from-[#0B1220] to-[#0a1628] p-6 rounded-2xl border border-white/10">
              ...
              <div className="mb-6">
                <button type="button" onClick={() => toggleSection("stops")}
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-full bg-blue-500/20 flex items-center justify-center text-base">✈️</div>
                    <div className="text-left">
                      <p className="text-sm font-semibold">Stops</p>
                      <p className="text-xs text-gray-500">Choose the number of stops</p>
                    </div>
                  </div>
                  <span className="text-gray-400 text-xs">{openSections.stops ? "▲" : "▼"}</span>
                </button>
                ...
                {openSections.stops && (
                  <div className="space-y-2">
                    {stopsOptions.map((s) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-lg bg-blue-500/10 flex items-center justify-center text-base">{s.icon}</div>
                          <div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <input type="radio" className="accent-blue-500 w-4 h-4"
              ...
              <div>
                <button type="button" onClick={() => toggleSection("airlines")}
                  ...
                  <span className="text-gray-400 text-xs">{openSections.airlines ? "▲" : "▼"}</span>
                </button>
              ...
              {summaryCards.map((card) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    <span>{card.icon}</span>
                    <span className="text-xs font-semibold uppercase tracking-wide text-gray-300">{card.label}</span>
                  </div>
                  {card.flight ? (
                    <>
                      <p className="text-sm font-medium truncate">{card.flight.airline}</p>
                      <p className="text-lg font-bold text-yellow-400">₹{card.flight.final_price.toLocaleString("en-IN")}</p>
          ...
          <div className="fixed bottom-0 left-0 w-full bg-[#0B1220] border-t border-white/10 px-6 py-4 z-50">
            <div className="max-w-7xl mx-auto flex items-center justify-between">
              <div className="flex flex-col">
                <span className="text-sm text-gray-400">Selected Flights</span>
